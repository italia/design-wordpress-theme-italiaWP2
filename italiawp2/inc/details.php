...
function italiawp2_edit_custom_settings() { ?>
    <div>
        ...
        <form method="post" action="options.php">
            ...
            <p><strong>Logo amministrazione afferente mobile:</strong><br />
                <input type="text" name="dettagli-logo-ammin-afferente-mobile" size="100" value="<?php echo get_option('dettagli-logo-ammin-afferente-mobile'); ?>" /></p>
            ...
            <input type="hidden" name="page_options" value="dettagli-num-articoli,
                                                            ...
                                                            dettagli-nome-ammin-afferente,dettagli-logo-ammin-afferente,dettagli-logo-ammin-afferente-mobile,dettagli-url-ammin-afferente,
